...
sed -i "/uci commit system/i uci add_list system.ntp.server=0.europe.pool.ntp.org" package/lean/default-settings/files/zzz-default-settings
...
sed -i "/uci commit ntpclient/i uci set ntpclient.@ntpserver[0].hostname='0.europe.pool.ntp.org'" package/lean/default-settings/files/zzz-default-settings
...
#添加额外非必须软件包
# me #git clone https://github.com/rufengsuixing/luci-app-adguardhome.git package/luci-app-adguardhome
#git clone https://github.com/garypang13/luci-app-bypass package/luci-app-bypass
# me #git clone https://github.com/vernesong/OpenClash.git package/OpenClash
